...
def install():
    ...
    shelltools.system("chmod 0644 libwidevinecdm.so")
    ...
    pisitools.insinto("/usr/lib64/opera-gx-stable/lib_extra/WidevineCdm/_platform_specific/linux_x64/", "libwidevinecdm.so")
